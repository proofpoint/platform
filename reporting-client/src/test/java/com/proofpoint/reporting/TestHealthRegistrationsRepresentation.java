...
public class TestHealthRegistrationsRepresentation
{
    ...
    {
        HealthRegistrationsRepresentation actual = new HealthRegistrationsRepresentation(ImmutableList.of(
                new HealthCheckRegistrationRepresentation("Some description"),
                new HealthCheckRegistrationRepresentation("Other description")
        ));
