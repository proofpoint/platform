...
public class JaxrsBinder
{
    ...
    private JaxrsBinder(Binder binder)
    {
        ...
        this.resourceBinder = newSetBinder(binder, Object.class, JaxrsInjectionProvider.class).permitDuplicates();
        this.adminResourceBinder = newSetBinder(binder, Object.class, AdminJaxrsResource.class).permitDuplicates();
        this.keyBinder = newSetBinder(binder, JaxrsBinding.class, JaxrsInjectionProvider.class).permitDuplicates();
