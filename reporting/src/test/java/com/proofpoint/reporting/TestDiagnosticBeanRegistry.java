...
public class TestDiagnosticBeanRegistry
{
    ...
    public void testRegister()
            throws Exception
    {
        registry.register(new Object(), TESTING_REPORTED_BEAN, "TestingObject");
        assertEquals(registry.getDiagnosticBeans(), ImmutableList.of(registrationInfo(TESTING_REPORTED_BEAN, "TestingObject")));
    }
            ...
            throws Exception
    {
        ...
        registry.register(object, TESTING_REPORTED_BEAN, "TestingObject");
