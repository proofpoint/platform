...
public class AnnotatedDiagnosticBinder
    extends NamedDiagnosticBinder
{
    AnnotatedDiagnosticBinder(DiagnosticMapping mapping)
    {
        super(mapping);
    }

    public NamedDiagnosticBinder annotatedWith(Annotation annotation)
    {
    ...
    public NamedDiagnosticBinder annotatedWith(Class<? extends Annotation> annotationClass)
    {
