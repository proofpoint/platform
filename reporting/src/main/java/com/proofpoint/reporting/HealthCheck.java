 ...
 * will be sent to the monitoring-acceptor service.
 *
 * A value of `null` indicates healthy; any other value indicates a critical
 * problem, with the value's {@link #toString()} used as the message.
 */
